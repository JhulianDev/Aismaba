import isotipo from "./generales/logo_white.png";
import carrito from "./generales/cart_white.png";
import fundadora1 from "./generales/2.png";
import fundadora2 from "./generales/3.jpg";
import escritorio from "./generales/4.jpg"
import comillas from "./generales/comillas.png";
import productosDigitales from "./generales/mockup-productos-digitales.png";
import nuestrosServicios from "./generales/mockup-nuestros-servicios.png";
import recursosGratuitos from "./generales/mockup-resursos-gratuitos.png";
import mulatasCakeLogoTestimonio from "./generales/testimonio_mulatas_cake1.png";
...
export const FUNDADORA_1 = fundadora1
export const FUNDADORA_2 = fundadora2
export const ESCRITORIO_AISMABA = escritorio
export const COMILLAS_GRISES = comillas
export const PRODUCTOS_DIGITALES = productosDigitales
export const NUESTROS_SERVICIOS = nuestrosServicios
export const RECURSOS_GRATUITOS = recursosGratuitos
export const MULATAS_CAKE_LOGO_TESTIMONIO = mulatasCakeLogoTestimonio
